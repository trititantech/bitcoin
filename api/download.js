...
export default async function handler(req, res) {
  ...
  try {
    ...
    } else if (movieName === "Gold") {
      filename = `Aureus_Gold_Pro_Algorithm_v1.7.2.exe`;
    } else if (movieName === "Silver") {
      filename = `Argentum_Silver_AI_Algorithm_v1.4.8.exe`;
    } else if (movieName === "Forex") {
      filename = `Forex_Quantum_Edge_Algorithm_v2.1.3.exe`;
    } else if (movieName === "Bitcoin") {
      filename = `Bitcoin_Quantum_Algorithm_v1.9.1.exe`;
    } else {
